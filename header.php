    ...
    <body>
        ...
        <div class="container main-dash ">
            ...
            <div class="start-dash">
                ...
                <!-- 
                <div>
                <font class="text-success" align="center"><?php //echo htmlentities($_SESSION['message']); 
           ...
           -->
                                    ...
                                    <li class="sidebar-dropdown">
                                      ...
                                      inner join courses on my_courses.course_id = courses.id  where my_courses.user_id = '" . $_SESSION['user_id'] . "'";
                                            ...
                                            ?>
                                                <ul>
                                                    <li>
                                                        <a href="./exams.php?course=<?php echo $row1['course']; ?>"><?php echo $row1['course']; ?> </a>
                                                    </li>
                ...
                <!-- Content -->
                <main class="s-layout__content p-5">
                    <hr class="hr">